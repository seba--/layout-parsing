raw1 <- subset(read.csv("all1339314685378.csv", sep=";"),select=c(path, run, time, byte.size,lines.of.code,all.success,reference.time))
raw2 <- subset(read.csv("all1339377065526.csv", sep=";"),select=c(time,all.success,reference.time))
raw3 <- subset(read.csv("all1339404021207.csv", sep=";"),select=c(time,all.success,reference.time))
