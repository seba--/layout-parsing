raw0 <- read.csv("evaluation/all1339404021207.csv", sep=";")
raw1 <- subset(raw0,select=c(path, run, time, byte.size,lines.of.code,all.success,reference.time))
raw2 <- subset(read.csv("evaluation/all1339404021207.csv", sep=";"),select=c(time,all.success,reference.time))
raw3 <- subset(read.csv("evaluation/all1339404021207.csv", sep=";"),select=c(time,all.success,reference.time))
