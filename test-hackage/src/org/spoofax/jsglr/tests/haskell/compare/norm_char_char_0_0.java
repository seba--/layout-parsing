...
{ 
  ...
  { 
    ...
    { 
      ...
      Success23:
      { 
        if(cons2 == CompareAST._consEscape_1)
        { 
          Fail30:
          { 
            IStrategoTerm arg56 = term.getSubterm(0);
            if(arg56.getTermType() != IStrategoTerm.APPL || CompareAST._consCharEsc_1 != ((IStrategoAppl)arg56).getConstructor())
              break Fail30;
        ...
        { 
          ...
          { 
            ...
            { 
              ...
              if(arg58.getTermType() != IStrategoTerm.APPL || CompareAST._consASCIIEsc_1 != ((IStrategoAppl)arg58).getConstructor())
                break Fail31;
          ...
          { 
            ...
            { 
              ...
              { 
                ...
                term = this.invoke(context, v_10);
                if(term == null)
                  break Fail32;
                term = termFactory.makeAppl(CompareAST._consEscape_1, new IStrategoTerm[]{term});
                if(true)
                  break Success25;
              }
              term = term23;
            ...
            Success26:
            { 
              if(cons2 == CompareAST._consHexadecimalEsc_1)
              { 
                Fail33:
                { 
                  IStrategoTerm s_10 = null;
                  s_10 = term.getSubterm(0);
                  term = hex_string_to_int_0_0.instance.invoke(context, s_10);
                  if(term == null)
                    break Fail33;
                  term = int_to_string_0_0.instance.invoke(context, term);
                  if(term == null)
                    break Fail33;
                  term = termFactory.makeAppl(CompareAST._consDecimalEsc_1, new IStrategoTerm[]{term});
                  if(true)
                    break Success26;
                }
                term = term23;
              ...
              Success27:
              { 
                if(cons2 == CompareAST._consOctalEsc_1)
                { 
                  Fail34:
                  { 
                    IStrategoTerm p_10 = null;
                    p_10 = term.getSubterm(0);
                    term = oct_string_to_int_0_0.instance.invoke(context, p_10);
                    if(term == null)
                      break Fail34;
                    term = int_to_string_0_0.instance.invoke(context, term);
                    if(term == null)
                ...
                Success28:
                { 
                  if(cons2 == CompareAST._consDecimalEsc_1)
                  { 
                    Fail35:
                    { 
                      IStrategoTerm l_10 = null;
                      l_10 = term.getSubterm(0);
                      term = string_to_int_0_0.instance.invoke(context, l_10);
                      if(term == null)
                        break Fail35;
                                                                            ...
                                                                            { 
                                                                              ...
                                                                              { 
                                                                                ...
                                                                                { 
                                                                                  ...
                                                                                  Success61:
                                                                                  { 
                                                                                    if(cons2 == CompareAST._consASCIIEsc_1)
                                                                                    { 
                                                                                      Fail68:
                                                                                      { 
