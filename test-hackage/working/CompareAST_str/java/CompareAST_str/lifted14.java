  ...
  { 
    ...
    { 
      ...
      { 
        Fail113:
        { 
          if(term.getTermType() != IStrategoTerm.APPL || CompareAST_str._consEscape_1 != ((IStrategoAppl)term).getConstructor())
            break Fail113;
          IStrategoTerm arg133 = term.getSubterm(0);
          if(arg133.getTermType() != IStrategoTerm.APPL || CompareAST_str._consCharEsc_1 != ((IStrategoAppl)arg133).getConstructor())
            break Fail113;
