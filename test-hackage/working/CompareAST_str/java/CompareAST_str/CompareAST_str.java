...
{ 
  ...
  { 
    ...
    constASCIIEsc0 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const2});
    const3 = termFactory.makeString("SOH");
    constASCIIEsc1 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const3});
    const4 = termFactory.makeString("STX");
    constASCIIEsc2 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const4});
    const5 = termFactory.makeString("ETX");
    constASCIIEsc3 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const5});
    const6 = termFactory.makeString("EOT");
    constASCIIEsc4 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const6});
    const7 = termFactory.makeString("ENQ");
    constASCIIEsc5 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const7});
    const8 = termFactory.makeString("ACK");
    constASCIIEsc6 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const8});
    const9 = termFactory.makeString("a");
    constCharEsc0 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const9});
    const10 = termFactory.makeString("b");
    constCharEsc1 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const10});
    const11 = termFactory.makeString("t");
    constCharEsc2 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const11});
    const12 = termFactory.makeString("n");
    constCharEsc3 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const12});
    const13 = termFactory.makeString("v");
    constCharEsc4 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const13});
    const14 = termFactory.makeString("f");
    constCharEsc5 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const14});
    const15 = termFactory.makeString("r");
    constCharEsc6 = termFactory.makeAppl(CompareAST_str._consCharEsc_1, new IStrategoTerm[]{CompareAST_str.const15});
    const16 = termFactory.makeString("SO");
    constASCIIEsc7 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const16});
    const17 = termFactory.makeString("SI");
    constASCIIEsc8 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const17});
    const18 = termFactory.makeString("DLE");
    constASCIIEsc9 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const18});
    const19 = termFactory.makeString("DC1");
    constASCIIEsc10 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const19});
    const20 = termFactory.makeString("DC2");
    constASCIIEsc11 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const20});
    const21 = termFactory.makeString("DC3");
    constASCIIEsc12 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const21});
    const22 = termFactory.makeString("DC4");
    constASCIIEsc13 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const22});
    const23 = termFactory.makeString("NAK");
    constASCIIEsc14 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const23});
    const24 = termFactory.makeString("SYM");
    constASCIIEsc15 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const24});
    const25 = termFactory.makeString("ETB");
    constASCIIEsc16 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const25});
    const26 = termFactory.makeString("CAN");
    constASCIIEsc17 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const26});
    const27 = termFactory.makeString("EM");
    constASCIIEsc18 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const27});
    const28 = termFactory.makeString("SUB");
    constASCIIEsc19 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const28});
    const29 = termFactory.makeString("ESC");
    constASCIIEsc20 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const29});
    const30 = termFactory.makeString("FS");
    constASCIIEsc21 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const30});
    const31 = termFactory.makeString("GS");
    constASCIIEsc22 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const31});
    const32 = termFactory.makeString("RS");
    constASCIIEsc23 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const32});
    const33 = termFactory.makeString("US");
    constASCIIEsc24 = termFactory.makeAppl(CompareAST_str._consASCIIEsc_1, new IStrategoTerm[]{CompareAST_str.const33});
